...
<html>
  ...
  <body>
    <form action="${pageContext.request.contextPath }/RecordActionServlet?method=updateRes&entity=record" method="post">
    	<table border="1px" align="center" cellspacing="0px" width="60%">
    		<tr>
