...
<script type="text/javascript">
		...
		function forward1() {
			...
			if(pagesize!="" && parseInt(pagesize)<parseInt(recordcount)) {
				location.href = "docBaseInfoServlet?item=edit&pagesize=" + pagesize;
			}
		}
		...
		function forward2() {
			...
			if(pagesize!="" && pagenum!="" && parseInt(pagenum)<parseInt(pagecount)) {
				location.href = "docBaseInfoServlet?item=edit&pagesize=" + pagesize + "&pagenum=" + pagenum;
			}
		}
						...
						<tr>
			   				<td colspan="9" align="center" height="30px">
			   					...
			   					<c:choose>
			   						...
			   						<c:otherwise>
			   							<a href="docBaseInfoServlet?item=edit&pagenum=1&pagesize=15" id="pageFirst">首页</a>
			   							<a href="docBaseInfoServlet?item=edit&pagenum=${page.pagenum-1}&pagesize=${page.pagesize}">上一页</a>
			   						</c:otherwise>
			   					</c:choose>
			   					<c:choose>
			   						...
			   						<c:otherwise>
			   							<a href="docBaseInfoServlet?item=edit&pagenum=${page.pagenum+1}&pagesize=${page.pagesize}">下一页</a>
