			   				...
			   				<tr>
								...
								<td height="20" bgcolor="#FFFFFF"><div align="center">
									<span class="STYLE19"><a
										href="${pageContext.request.contextPath}/deleteEmp?e_id=${p.e_id }">删除
									</a>| <a
										href="${pageContext.request.contextPath}/addEmp?item=view&e_id=${p.e_id }&e_name=${p.ename }">查看</a></span>
								</div></td>
			   				</tr>
			   			</c:forEach>
						<!-- 分页 -->
