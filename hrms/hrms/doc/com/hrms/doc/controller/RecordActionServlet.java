...
import com.hrms.doc.action.Action;

public class RecordActionServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public RecordActionServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String url = config.getInitParameter(path);
